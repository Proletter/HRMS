...
class Asset(HRMSModel):
    ...
    objects = HRMSCompanyManager("asset_category_id__company_id")
...
class AssetDocuments(HRMSModel):
    """
...
class AssetAssignment(HRMSModel):
    """
    ...
    objects = HRMSCompanyManager("asset_id__asset_lot_number_id__company_id")
