...
This module is used to write HRMS form select widgets
"""
...
class HRMSMultiSelectWidget(forms.Widget):
    """
    HRMSMultiSelectWidget
    """
    ...
    template_name = "HRMS_widgets/HRMS_multiselect_widget.html"
