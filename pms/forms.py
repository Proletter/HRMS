...
class ObjectiveForm(BaseForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["assignees"] = HRMSMultiSelectField(
        ...
        self.fields["managers"] = HRMSMultiSelectField(
            queryset=Employee.objects.all(),
            widget=HRMSMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
...
class FeedbackForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if instance:
            kwargs["initial"] = set_date_field_initial(instance)
        super().__init__(*args, **kwargs)
        self.fields["subordinate_id"] = HRMSMultiSelectField(
            queryset=Employee.objects.all(),
            widget=HRMSMultiSelectWidget(
                filter_route_name="employee-widget-filter",
                filter_class=EmployeeFilter,
...
class MeetingsForm(BaseForm):
    ...
    def clean(self):
        ...
        if isinstance(self.fields["employee_id"], HRMSMultiSelectField):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.instance.pk:
            ...
            self.fields["employee_id"] = HRMSMultiSelectField(
