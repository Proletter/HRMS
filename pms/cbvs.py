...
from HRMS.decorators import login_required, permission_required
...
class BonusPointSettingSectionView(views.HRMSSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingNavView(views.HRMSNavView):
    """
...
class BonusPointSettingFormView(views.HRMSFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingListView(views.HRMSListView):
    """
...
class EmployeeBonusPointSectionView(views.HRMSSectionView):
    """
...
class EmployeeBonusPointNavView(views.HRMSNavView):
    """
    BonusPoint nav view
    """
...
class EmployeeBonusPointFormView(views.HRMSFormView):
    """
    BonusPointForm View
    """
...
class EmployeeBonusPointListView(views.HRMSListView):
    """
    BnusPoint list view
    """
