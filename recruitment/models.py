...
from HRMS_audit.methods import get_diff
...
class SurveyTemplate(HRMSModel):
    """
...
class Stage(HRMSModel):
    ...
    objects = HRMSCompanyManager(related_company_field="recruitment_id__company_id")
...
from HRMS.signals import pre_bulk_update


class RejectReason(HRMSModel):
    """
    RejectReason
    """
...
class RejectedCandidate(HRMSModel):
    """
    RejectedCandidate
    """
...
class RecruitmentSurvey(HRMSModel):
    """
    ...
    objects = HRMSCompanyManager(related_company_field="recruitment_ids__company_id")
...
class QuestionOrdering(HRMSModel):
    """
...
class RecruitmentSurveyAnswer(HRMSModel):
    """
...
class RecruitmentMailTemplate(HRMSModel):
...
class SkillZoneCandidate(HRMSModel):
    """
...
class CandidateRating(HRMSModel):
...
class RecruitmentGeneralSetting(HRMSModel):
    """
...
class InterviewSchedule(HRMSModel):
    """
