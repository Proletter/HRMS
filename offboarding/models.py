...
class OffboardingStage(HRMSModel):
    """
    Offboarding model
    """
...
class OffboardingStageMultipleFile(HRMSModel):
    """
...
class OffboardingEmployee(HRMSModel):
    """
...
class ResignationLetter(HRMSModel):
    """
    ...
    def to_offboarding_employee(
        ...
        contract_notice_end_date = (
            get_HRMS_model_class(app_label="payroll", model="contract")
...
class OffboardingTask(HRMSModel):
    """
...
class OffboardingNote(HRMSModel):
    """
    OffboardingNote
    """
...
class OffboardingGeneralSetting(HRMSModel):
    """
