...
from base.models import HRMSMailTemplate, JobPosition
...
from HRMS.group_by import group_by_queryset as general_group_by
...
def candidates_view(request):
    ...
    mail_templates = HRMSMailTemplate.objects.all()
...
def email_send(request):
    ...
    bodys = list(
        HRMSMailTemplate.objects.filter(id__in=template_attachment_ids).values_list(
            "body", flat=True
        )
    )
