...
from HRMS_views.cbv_methods import get_short_uuid, login_required
from HRMS_views.forms import SavedFilterForm
from HRMS_views.generic.cbv.views import HRMSFormView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.HRMSModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(HRMSFormView):
    """
    SavedFilter
    """
