...
class JobPositionMultiForm(ModelForm):
    ...
    department_id = HRMSMultiSelectField(queryset=Department.objects.all())
...
class PenaltyAccountForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if apps.is_installed("leave") and employee:
            LeaveType = get_HRMS_model_class(app_label="leave", model="leavetype")
