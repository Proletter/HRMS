...
from HRMS_widgets.forms import HRMSForm
...
class AllowanceForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["specific_employees"] = HRMSMultiSelectField(
...
class GeneratePayslipForm(HRMSForm):
    """
    Form for Payslip
    """
...
class ReimbursementForm(ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        if apps.is_installed("leave"):
            AvailableLeave = get_HRMS_model_class(
