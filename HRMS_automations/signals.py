...
from HRMS.signals import post_bulk_update, pre_bulk_update
...
def start_automation():
    ...
    Automation signals
    """
    from HRMS_automations.methods.methods import get_model_class, split_query_string
...
def send_automated_mail(
    ...
    from HRMS_automations.methods.methods import evaluate_condition, operator_map
...
def send_mail(request, automation, instance):
    ...
    from HRMS_automations.methods.methods import (
        get_model_class,
