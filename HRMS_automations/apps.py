...
from HRMS_automations.signals import start_automation


class HRMSAutomationConfig(AppConfig):
    default_auto_field = "django.db.models.BigAutoField"
    name = "HRMS_automations"

    def ready(self) -> None:
        ready = super().ready()
        try:

            from base.templatetags.HRMSfilters import app_installed
            from employee.models import Employee
            from HRMS_automations.methods.methods import get_related_models
            from HRMS_automations.models import MODEL_CHOICES
