...
class MailAutomation(HRMSModel):
    """
    MailAutoMation
    """
    ...
    mail_template = models.ForeignKey(HRMSMailTemplate, on_delete=models.CASCADE)
    ...
    def get_mail_to_display(self):
        ...
        return render_template(
            "HRMS_automations/mail_to.html", {"instance": self, "mappings": mappings}
        )
    ...
    def conditions(self):
        return render_template(
            "HRMS_automations/conditions.html", {"instance": self}
        )
