"""
HRMS_automation/views/views.py
"""
...
from HRMS_automations.methods.methods import generate_choices
from HRMS_automations.methods.serialize import serialize_form
...
@login_required
@permission_required("HRMS_automation")
