"""
This module provides HRMS ModelForms for creating and managing leave-related data,
...
from HRMS_widgets.forms import HRMSForm, HRMSModelForm
from HRMS_widgets.widgets.HRMS_multi_select_field import HRMSMultiSelectField
from HRMS_widgets.widgets.select_widgets import HRMSMultiSelectWidget
...
class LeaveTypeForm(ConditionForm):
    ...
    employee_id = HRMSMultiSelectField(
        queryset=Employee.objects.all(),
        widget=HRMSMultiSelectWidget(
...
class LeaveRequestCreationForm(ModelForm):
    ...
    def as_p(self, *args, **kwargs):
        ...
        """
        context = {"form": self}
        table_html = render_to_string("HRMS_form.html", context)
        return table_html
...
class LeaveOneAssignForm(HRMSModelForm):
    """
    ...
    Attributes:
        - employee_id: A HRMSMultiSelectField representing the employee to assign leave to.
    """
...
class AssignLeaveForm(HRMSForm):
    """
    Form for Payslip
    """
