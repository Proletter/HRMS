...
class AvailableLeave(HRMSModel):
...
class LeaverequestComment(HRMSModel):
    """
...
class LeaveAllocationRequest(HRMSModel):
    leave_type_id = models.ForeignKey(
...
class LeaveallocationrequestComment(HRMSModel):
    """
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaveRequest(HRMSModel):
        leave_type_id = models.ForeignKey(
            LeaveType, on_delete=models.PROTECT, verbose_name="Leave type"
        )
        employee_id = models.ForeignKey(
...
class LeaveGeneralSetting(HRMSModel):
    """
...
if apps.is_installed("attendance"):
    ...
    class CompensatoryLeaverequestComment(HRMSModel):
        """
...
class EmployeePastLeaveRestrict(HRMSModel):
...
if apps.is_installed("attendance"):
    ...
    class OverrideLeaveRequests(LeaveRequest):
        ...
        def leaverequest_pre_save(sender, instance, **_kwargs):
            ...
            """
            WorkRecords = get_HRMS_model_class(
