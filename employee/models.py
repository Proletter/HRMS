...
class Employee(models.Model):
    ...
    def get_archive_condition(self):
        ...
        if apps.is_installed("onboarding"):
            OnboardingStage = get_HRMS_model_class("onboarding", "onboardingstage")
            OnboardingTask = get_HRMS_model_class("onboarding", "onboardingtask")
        ...
        if apps.is_installed("recruitment"):
            Recruitment = get_HRMS_model_class("recruitment", "recruitment")
            Stage = get_HRMS_model_class("recruitment", "stage")
    ...
    def check_online(self):
        ...
        """
        if apps.is_installed("attendance"):
            Attendance = get_HRMS_model_class("attendance", "attendance")
...
class EmployeeBankDetails(HRMSModel):
    """
...
class PolicyMultipleFile(HRMSModel):
    """
...
class DisciplinaryAction(HRMSModel):
    """
    Disciplinary model
    """
...
class EmployeeGeneralSetting(HRMSModel):
    """
