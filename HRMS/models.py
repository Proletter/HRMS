...
This module defines the abstract base model `HRMSModel` for the HRMS HRMS project.
The `HRMSModel` provides common fields and functionalities for other models within
...
class HRMSModel(models.Model):
    ...
    HRMS_history = AuditlogHistoryField()
    objects = models.Manager()
    is_active = models.BooleanField(default=True, verbose_name=_("Is Active"))

    class Meta:
        """
        Meta class for HRMSModel
        """
    ...
    def save(self, *args, **kwargs):
        ...
        super(HRMSModel, self).save(*args, **kwargs)
...
auditlog.register(HRMSModel, serialize_data=True)
